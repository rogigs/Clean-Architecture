...

{
    ...
    public class ProjectController : ControllerBase, IProjectController
    {
        ...
        public ProjectController(ICreateProject createProject, IReadProject readProject, IReadProjects readProjects, IDeleteProject deleteProject, IUpdateProject updateProject)
        {
        ...
        {
            var project = await _readProjects.ExecuteAsync(new Pagination(take, skip));
